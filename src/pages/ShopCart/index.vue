      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" :value="cart.skuNum" minnum="1" class="itxt" @input="handler('change',$event.target.value*1,cart)" />
    ...
    methods:{
      ...
      handler:throttle(async function(type,disNum,cart) {
        ...
        try {
          ...
          await this.$store.dispatch("detail/AddShopCart", {skuId: cart.skuId, skuNum: disNum});
          this.getData();
        } catch (error) {}
      },1000),
      // 删除商品数据
